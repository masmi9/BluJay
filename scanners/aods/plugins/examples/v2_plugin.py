#!/usr/bin/env python3
"""
examples - BasePluginV2 Implementation
===========================================
...
class ExamplesV2(BasePluginV2):
    ...
    def get_metadata(self) -> PluginMetadata:
        ...
        return PluginMetadata(
            name="examples",
            version="2.0.0",
            description="Examples - Migrated to BasePluginV2",
            author="AODS Team",
    ...
    def _call_legacy_function(self, apk_ctx) -> Any:
        ...
        for func_name in legacy_functions:
            ...
            try:
                ...
                current_module = importlib.import_module("plugins.examples")
    ...
    def _create_finding_from_item(self, item: Any, index: int) -> PluginFinding:
        ...
        if isinstance(item, dict):
            return PluginFinding(
                finding_id=f"examples_{index:03d}",
...
def create_plugin() -> ExamplesV2:
    """Create plugin instance."""
    return ExamplesV2()


__all__ = ["ExamplesV2", "create_plugin"]
